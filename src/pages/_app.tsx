...
const MyApp: AppType<{ session: Session | null }> = ({
  ...
  return (
    <SessionProvider session={session}>
      ...
      <header className="fixed top-0 flex h-14 w-screen items-center bg-green-600 bg-gradient-to-r from-green-500 via-green-500 to-green-400 px-2 text-2xl font-medium text-green-950">
        {asPath === "/" || asPath === "/home" ? (
          <h1>Home</h1>
        ) : (
