...
const MyApp: AppType<{ session: Session | null }> = ({
  ...
  return (
    <SessionProvider session={session}>
      ...
      <footer className="fixed bottom-0 pt-2 flex h-[calc(4rem+env(safe-area-inset-bottom))] w-screen justify-center bg-gradient-to-r from-green-400 via-green-600 to-green-400 text-green-950">
        <nav>
